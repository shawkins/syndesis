...
public class SampleTableItemInfo {
    ...
    public SampleTableItemInfo() {
        super();
    }

    private static List<CompletionItem> sampleTableItems = null;

    private static final String[] PARTS_ITEM_DATA = {
            "parts",   // String label;
            null, // String detail;
    ...
    private static final String[] SUPPLIER_ITEM_DATA = {
    ...
    private static final String[] CUSTOMER_ITEM_DATA = {
    ...
    private static final String[] SHIP_VIA_ITEM_DATA = {
    ...
    private static final String[] PARTS_SUPPLIER_ITEM_DATA = {
    ...
    public static Map<String, String[]> SAMPLE_PARTS_ITEM_DATA = Collections
