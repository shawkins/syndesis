...
public abstract class AbstractLanguageServer {
    ...
    private final class TeiidServerRunnable implements Runnable {
        @Override
        public void run() {
            LOGGER.info("Starting DDL Teiid Language Server...");
    ...
    public int startServer() {
        runner = new Thread(new TeiidServerRunnable(), "Camel Language Client Watcher");
        runner.start();
        return 0;
    }
     ...
     */
    protected void setTextDocumentService(TeiidDdlTextDocumentService textDocumentService) {
